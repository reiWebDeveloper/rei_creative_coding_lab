...
> A self-driven journey to become a systems developer — one experiment at a time.
> Built with **Vanilla JavaScript** | Started: 2026 | Goal: 100 projects in 12 months
...
- [x] 17 — Drag & Drop Box
- [x] 18 — Random Quote Generator
- [x] 19 — Theme Switcher (Dark/Light)
- [x] 20 — Interactive Grid Painter
...
- [x] 29 — Rain Simulation
- [x] 30 — Snow Simulation
